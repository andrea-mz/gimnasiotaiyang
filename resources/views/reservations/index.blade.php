        ...
        @forelse($reservations as $reservation)
            <tr>
                ...
                @if(Auth::user()->hasroles('admin'))
                    ...
                    <td class="d-flex"><a href="{{ route('reservations.edit', ['reservation' => $reservation]) }}" class="btn btn-outline-warning mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
